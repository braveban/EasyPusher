...
*/
#ifdef _WIN32
#define KEY "6A36334A743469576B5A754144474A636F35337A4A65784659584E355548567A6147567958314A55553141755A58686C567778576F502B6C3430566863336C4559584A33615735555A57467453584E55614756435A584E30514449774D54686C59584E35"
#define EasyRTSPClient_KEY "79393674363469576B5A7541726B64636F376851792B784659584E355548567A6147567958314A55553141755A58686C567778576F50394C3430566863336C4559584A33615735555A57467453584E55614756435A584E30514449774D54686C59584E35"
#include "getopt.h"
#else //linux
#define KEY "6A36334A74354F576B59714144474A636F35337A4A66426C59584E356348567A6147567958334A3063334258444661672F36586A5257467A65555268636E6470626C526C5957314A6331526F5A554A6C633352414D6A41784F47566863336B3D"
#define EasyRTSPClient_KEY "7939367436354F576B5971416C3039636F37426E792F426C59584E356348567A6147567958334A3063334258444661672F30766A5257467A65555268636E6470626C526C5957314A6331526F5A554A6C633352414D6A41784F47566863336B3D"
#include "unistd.h"
#include <signal.h>
#endif
...
int Easy_APICALL __RTSPSourceCallBack( int _chid, void *_chPtr, int _mediatype, char *pbuf, RTSP_FRAME_INFO *frameinfo)
{
	if (_mediatype == EASY_SDK_VIDEO_FRAME_FLAG)
	{
		if((fPusherHandle == 0) && (fSourceMediaInfo != NULL) && (frameinfo->type == EASY_SDK_VIDEO_FRAME_I))
		{
			...
			EasyPusher_StartStream(fPusherHandle, ConfigIP, atoi(ConfigPort), ConfigName, EASY_RTP_OVER_TCP, "admin", "admin", &mediainfo, 1024, false);//1M������
